...
// the average number of strokes a golfer is expected to make in order to 
// sink the ball in the hole to complete the play. 
...
// got clearity about if else conditions
